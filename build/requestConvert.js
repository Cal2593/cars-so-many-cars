...
function requestConvert(reservationRequest, valetResponse, coverResponse, elecResponse, vehicleForm) {
    const searchable = new searchableUserReservationRequest_1.searchableUserReservationRequest(reservationRequest.userID, reservationRequest.vehicleRegistration, vehicleForm, reservationRequest.reservationIntervalDateTime, elecResponse, coverResponse, valetResponse, reservationRequest.accessibleSpotRequired, reservationRequest.specificLocationRequired);
    return searchable;
}
