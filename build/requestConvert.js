...
function requestConvert(reservationRequest, valetResponse, coverResponse, elecResponse, vehicleForm) {
    const searchable = new searchableUserReservationRequest_1.searchableUserReservationRequest(reservationRequest.userID, reservationRequest.vehicleRegistration, vehicleForm, reservationRequest.reservationStartDateTime, reservationRequest.reservationEndDateTime, elecResponse, coverResponse, valetResponse, reservationRequest.specificLocationRequired);
    return searchable;
}
